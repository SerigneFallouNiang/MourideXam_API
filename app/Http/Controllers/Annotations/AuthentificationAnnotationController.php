 ...
 *     summary="gestion profil pour un utilisateur",
 *     description="",
 *         security={
 *    {       "BearerAuth": {}}
 *         },
 ...
 * ),
 *     @OA\Parameter(in="path", name="password_confirmation", required=false, @OA\Schema(type="string")
 * ),
 *     @OA\Parameter(in="path", name="telephone", required=false, @OA\Schema(type="string")
 * ),
 *     @OA\Parameter(in="path", name="progress", required=false, @OA\Schema(type="string")
 * ),
 *     @OA\Parameter(in="header", name="User-Agent", required=false, @OA\Schema(type="string")
 * ),
 *     tags={"Authentification"},
